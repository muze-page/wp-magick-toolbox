    ...
    class MaBox_Privacy
    {
        ...
        private static $external_services = array(
            ...
            array(
                'name'        => '阿里云对象存储 OSS',
                'provider'    => '阿里云',
                'purpose'     => '将 WordPress 媒体文件上传到管理员选择的对象存储',
                'trigger'     => '管理员启用对象存储、选择阿里云并完成凭据配置，之后上传媒体文件时',
                'data_sent'   => '媒体文件内容、对象路径、Bucket/Region、AccessKey 标识和签名请求头',
                'data_stored' => 'AccessKey、SecretKey、Bucket、Region 与 CDN 域名存在本站 WordPress 数据库',
                'opt_in'      => true,
            ...
            array(
                ...
                'provider'    => '腾讯云',
                'purpose'     => '将 WordPress 媒体文件上传到管理员选择的对象存储',
                'trigger'     => '管理员启用对象存储、选择腾讯云并完成凭据配置，之后上传媒体文件时',
                'data_sent'   => '媒体文件内容、对象路径、Bucket/Region、AccessKey 标识和签名请求头',
                'data_stored' => 'AccessKey、SecretKey、Bucket、Region 与 CDN 域名存在本站 WordPress 数据库',
                'opt_in'      => true,
                'config_key'  => 'performance.oss.enabled',
            ...
            array(
                ...
                'provider'    => '七牛云',
                'purpose'     => '将 WordPress 媒体文件上传到管理员选择的对象存储',
                'trigger'     => '管理员启用对象存储、选择七牛云并完成凭据配置，之后上传媒体文件时',
                'data_sent'   => '媒体文件内容、对象路径、Bucket、AccessKey 标识和上传凭证',
                'data_stored' => 'AccessKey、SecretKey、Bucket 与 CDN 域名存在本站 WordPress 数据库',
                'opt_in'      => true,
                'config_key'  => 'performance.oss.enabled',
        ...
        public static function get_privacy_data()
        {
            return array(
                ...
                'privacy_policy' => array(
                    ...
                    'api_keys'        => '用户配置的凭据存储在 WordPress 数据库中，仅在管理员启用对应微信或对象存储功能后用于服务端鉴权请求；插件不会把凭据发送给开发者。',
                ),
            );
        }
    }
