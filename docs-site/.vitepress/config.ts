      ...
      '/features/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '点击特效', link: '/features/page-appearance/click-effect' },
            { text: '美化滚动条', link: '/features/page-appearance/beautiful-scrollbar' },
            { text: '屏幕上有根毛', link: '/features/page-appearance/screen-hair' },
            { text: '全站变灰', link: '/features/page-appearance/site-grayscale' },
            { text: '灯笼效果', link: '/features/page-appearance/lantern-effect' },
            { text: '像素小鸡', link: '/features/page-appearance/pixel-chick' },
            { text: '已写完的书', link: '/features/page-appearance/finished-book' },
            ...
            { text: '背景特效', link: '/features/page-appearance/background-effect' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: '前端调试', link: '/features/page-function/frontend-debug' },
            ...
            { text: '文章评分', link: '/features/page-function/article-rating' },
        ...
        },
        {
          text: '页面模板',
          items: [
            { text: '文章列表模板', link: '/features/page-templates/article-list-template' },
            { text: '立体三角模板', link: '/features/page-templates/3d-triangle-template' },
            { text: '专题列表模板', link: '/features/page-templates/topic-list-template' },
          ],
        },
        {
          text: '微信小程序',
          items: [
            { text: '生成小程序跳转链接', link: '/features/wechat-mini-program/generate-link' },
          ],
        },
        {
          text: 'B2 主题专属',
        ...
        },
        {
          ...
          items: [
            ...
            { text: '用户反馈', link: '/features/other/user-feedback' },
            { text: '增值服务', link: '/features/other/value-added-services' },
            { text: '工单系统', link: '/features/other/ticket-system' },
            { text: '日记文章类型', link: '/features/other/diary-post-type' },
