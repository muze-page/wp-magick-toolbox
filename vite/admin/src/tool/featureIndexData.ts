...
export const searchIndex: SearchItem[] = [
  ...
  { id: "domestic-login_security-attempt_limit_enabled", label: "登录尝试保护", tabKey: "china", tabLabel: "国内生态", section: "登录安全", keywords: ["login", "登录", "失败", "限制", "锁定", "代理"], tags: ["推荐", "安全"] },
  { id: "domestic-login_security-anonymous_author_guard_enabled", label: "限制匿名作者枚举", tabKey: "china", tabLabel: "国内生态", section: "登录安全", keywords: ["login", "登录", "枚举", "作者", "用户名", "REST"], tags: ["安全"] },
